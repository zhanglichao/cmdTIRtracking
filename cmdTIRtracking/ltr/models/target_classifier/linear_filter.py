...
class LinearFilter(nn.Module):
    ...
    def forward(self, train_feat, test_feat_t, test_bb, *args, **kwargs):
        ...
        assert test_bb.dim() == 3

        num_sequences = test_bb.shape[1]
        ...
        # Train filter
        filter, filter_iter, losses = self.get_filter(train_feat, test_bb, *args, **kwargs)
