...
class KLDiMPProcessing(BaseProcessing):
    ...
    def __call__(self, data: TensorDict):
        ...
        if self.transform['joint'] is not None:
            # data['train_images'] = self.transform['joint'](image=data['train_images'])
            # data['train_images_t'] = self.transform['joint'](image=data['train_images_t'])
            # data['test_images'] = self.transform['joint'](image=data['test_images'], new_roll=False)
            # data['test_images_t'] = self.transform['joint'](image=data['test_images_t'], new_roll=False)
            data['train_images'], data['train_anno'] = self.transform['joint'](image=data['train_images'], bbox=data['train_anno'])
            data['test_images'], data['test_anno'] = self.transform['joint'](image=data['test_images'], bbox=data['test_anno'])
